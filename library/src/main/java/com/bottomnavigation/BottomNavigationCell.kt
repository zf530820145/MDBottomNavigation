...
import com.zf.bottomnavigation.databinding.ItemTabNavigationCellBinding
...
@Suppress("unused")
class BottomNavigationCell @JvmOverloads constructor(
    context: Context,
    ...
    private val binding = DataBindingUtil.inflate<ItemTabNavigationCellBinding>(
        LayoutInflater.from(context),
        R.layout.item_tab_navigation_cell,
        this,
        true
    )
